    ...
    public static void main(String[] args) {
        ...
        for (String imageUrl : imageUrls) {
            try {
                ...
                long recursiveSize = recursiveFile.length();
                String recursiveSizeKB = convertBytesToKB(recursiveSize);
                ...
                long iterativeSize = iterativeFile.length();
                String iterativeSizeKB = convertBytesToKB(iterativeSize);
                long iterativeTime = System.nanoTime() - startTime;

                // Display results in the desired table format
                System.out.printf("| %-17s | %-23s | %-22s | %-22.10f | %-22s | %-22.10f |\n", 
                        "Gambar " + imageCounter, originalSizeKB, iterativeSizeKB, iterativeTime / 1_000_000_000.0, recursiveSizeKB, recursiveTime / 1_000_000_000.0);
